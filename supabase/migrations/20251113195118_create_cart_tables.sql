/*
  ...
  ## Overview
  Creates tables for shopping cart with Amazon affiliate product links.
  ...
  1. New Tables
    - `cart_items`
      ...
      - `amazon_product_url` (text) - Amazon affiliate link
      - `amazon_product_name` (text) - Product name on Amazon
      - `price` (numeric) - estimated price
      - `image_url` (text) - product image
      - `source_recipe_id` (uuid, nullable) - which recipe this came from
  ...
  ## Important Notes
  - Amazon affiliate links stored for each ingredient
  - Links to specific products for easy purchasing
  - Price and images help users make decisions
  - Tracks which recipe each ingredient came from
*/
