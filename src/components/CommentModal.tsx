...
export function CommentModal({ postId, isOpen, onClose, onCommentPosted }: CommentModalProps) {
  ...
  if (!post && loading) {
    return (
<Dialog open={isOpen && !isMinimized} onOpenChange={onClose}>        <DialogContent className="max-w-lg w-[95vw] h-[90vh] sm:max-h-[85vh] p-0 gap-0 overflow-hidden z-[9999] flex flex-col">
