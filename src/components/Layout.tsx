...
<header className="fixed top-0 left-0 right-0 z-[150] border-b border-gray-200 bg-white shadow-sm pt-[env(safe-area-inset-top)]">
  <div className="flex h-14 sm:h-16 items-center justify-between px-3 sm:px-4 md:px-6 pt-2">
    <Button
      variant="ghost"
      size="icon"
...
<div className="hidden lg:block fixed top-3 right-3 z-40">
  <div className="flex items-center gap-1.5 bg-white/90 backdrop-blur-lg rounded-full shadow-lg border border-gray-200/50 px-2 py-1.5">
   ...
   <main className="pt-[calc(4.5rem+env(safe-area-inset-top))] sm:pt-[calc(5rem+env(safe-area-inset-top))] pb-28">
  {children}
</main>
...
<div className="relative bg-white border-t border-gray-200 shadow-lg pb-16">
...
<button
  ...
  className="relative -mt-3 flex items-center justify-center bg-gradient-to-br from-orange-500 to-red-600 rounded-full shadow-xl hover:shadow-2xl transition-all active:scale-95 touch-manipulation"
