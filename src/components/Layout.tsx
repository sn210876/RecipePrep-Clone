 ...
 const FloatingNavIcons = () => (
  ...
  ${
    isActive
      ...
      : 'bg-transparent text-gray-700 opacity-100 hover:opacity-50 hover:scale-110 ring-1 ring-blue-300 ring-offset-1 focus:outline-none focus:ring-2 focus:ring-blue-300'
  }`}
