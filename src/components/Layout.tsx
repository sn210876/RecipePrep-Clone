...
const loadUnreadCount = async (userId: string) => {
  ...
  return (
   ...
   <aside className={`fixed left-0 top-0 z-40 h-screen w-64 sm:w-60 lg:w-56 transform bg-white shadow-2xl transition-transform duration-300 ease-in-out lg:translate-x-0 ${
