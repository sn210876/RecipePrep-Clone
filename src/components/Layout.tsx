...
const loadUnreadCount = async (userId: string) => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <aside className={`fixed left-0 top-0 z-40 h-screen w-64 sm:w-72 transform bg-white shadow-2xl transition-transform duration-300 ease-in-out lg:translate-x-0 ${
