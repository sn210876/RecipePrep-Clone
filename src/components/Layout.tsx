...
export function Layout({ children, currentPage, onNavigate }: LayoutProps) {
  ...
  // REAL-TIME MESSAGING - Initialize on mount
  useEffect(() => {
    loadAvatar();
    initializeMessaging();
  }, []);

  // REAL-TIME MESSAGING - Subscribe to message updates
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="lg:ml-64">
        ...
        {/* Messages + Profile — Bottom corners with real-time badge */}
                ...
                <TooltipTrigger asChild>
                  <div className="relative">
                    <button
                      onClick={() => {
                        onNavigate('messages');
                        setUnreadCount(0); // Clear badge when clicking messages
                      }}
                    ...
                    {/* Red badge with pulse - REAL unread count */}
                    {unreadCount > 0 && (
