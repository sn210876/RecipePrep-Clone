  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      <div className="max-w-sm mx-auto" onClick={() => { setShowNotifications(false); setShowSearchResults(false); }}>
        ...
        {/* MOVED SEARCH BAR — NO CHEFHAT ICON */}
        ...
        {/* Your modals (CommentModal, AlertDialogs, Share Dialog, etc.) — unchanged */}
        {commentModalPostId && (
          <CommentModal
        ...
        {/* ... rest of your modals exactly as before ... */}
      </div>
    </div>
  );
}