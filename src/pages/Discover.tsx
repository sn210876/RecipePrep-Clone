...
export function Discover({ onNavigateToMessages, onNavigate, sharedPostId, onPostViewed }: DiscoverProps = {}) {
  ...
  // ... [all your useEffects and logic remain unchanged] ...
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      <div className="max-w-sm mx-auto" onClick={() => { setShowNotifications(false); setShowSearchResults(false); }}>
        ...
        {/* MOVED DOWN + CLEANED UP SEARCH BAR — NO CHEFHAT */}
        <div className="fixed top-20 left-0 right-0 z-40 bg-white border-b border-gray-200 px-4 pt-3 pb-4 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            {/* ONLY BELL ICON — CHEFHAT REMOVED */}
            <button
              onClick={async (e) => {
                e.stopPropagation();
        ...
        <div className="pt-28">
          {/* ... rest of your feed content (posts, hashtag filter, etc.) remains 100% unchanged ... */}
          {filterHashtag && (
          ...
          {/* Your existing post list, modals, etc. — NO CHANGES BELOW */}
          {viewingUserId ? (
            <UserProfileView
            ...
            // ... your posts.map() and everything else stays exactly the same ...
            <></>
          )}
        </div>

        {/* All your modals (CommentModal, AlertDialogs, etc.) remain unchanged */}
        {commentModalPostId && (
          <CommentModal
