...
These recipes have been selected from all over <span className="font-bold text-blue-600">Social Media</span> & the <span className="font-bold text-blue-600"> Web</span>
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
Let's get <span className="font-bold text-blue-600">cooking, commenting, or adding your own! <span className="font-bold text-blue-600">Social Media</span> & the <span className="font-bold text-blue-600"> Web</span>
</p> 
        </div>
