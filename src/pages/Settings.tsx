              ...
              <div className="space-y-4 md:grid md:grid-cols-2 md:gap-6 md:space-y-0">
                ...
                <div className="space-y-3 sm:space-y-4">
                  <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    <h3 className="text-sm sm:text-base md:text-lg font-semibold text-slate-900">From Social Media</h3>
                  </div>
                  <div className="bg-slate-50 rounded-lg p-3 sm:p-4 border border-slate-200">
                    ...
                    <ol className="space-y-2 text-xs sm:text-sm text-slate-700">
                      ...
                      <li className="flex items-start gap-2">
                        ...
                        <span>For website, click "Ctrl/CMD" → "C" over hyperlink</span>
                      </li>
                      <li className="flex items-start gap-2">
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div className="bg-slate-50 rounded-lg p-3 sm:p-4 border border-slate-200">
                    ...
                    <ol className="space-y-2 text-xs sm:text-sm text-slate-700">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="font-semibold text-blue-600 shrink-0">3.</span>
                        <span>Select your photo(s) in device → Upload</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="font-semibold text-blue-600 shrink-0">4.</span>
