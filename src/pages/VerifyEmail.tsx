        ...
        <div className="bg-white rounded-2xl shadow-2xl p-6 sm:p-8 border border-red-100">
          ...
          <div className="bg-orange-50 border border-orange-200 rounded-lg p-3 sm:p-4 mb-4 sm:mb-6">
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm text-orange-800 min-w-0">
                <p className="font-medium mb-1">Email sent to:</p>
                <p className="font-mono text-xs sm:text-sm text-orange-900 break-all">{user?.email}</p>
              </div>
            </div>
          </div>
          ...
          {error && (
            <div className="bg-red-50 border border-red-200 text-red-700 px-3 sm:px-4 py-2 sm:py-3 rounded-lg text-xs sm:text-sm mb-4">
              {error}
            </div>
          )}

          {message && (
            <div className="bg-green-50 border border-green-200 text-green-700 px-3 sm:px-4 py-2 sm:py-3 rounded-lg text-xs sm:text-sm mb-4">
              {message}
            </div>
          )}
          ...
          <div className="space-y-3">
            <Button
              ...
              disabled={loading}
              className="w-full bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-700 hover:to-red-700 text-white font-semibold h-11 sm:h-12 text-sm sm:text-base shadow-lg"
            >
              {loading ? (
            ...
            <Button
              ...
              variant="outline"
              className="w-full border-orange-300 text-orange-700 hover:bg-orange-50 h-11 sm:h-12 text-sm sm:text-base"
            >
