...
export const mockRecipes: Recipe[] = [
  ...
  },
  {
    ...
    instructions: [
      'Mound flour on clean surface and make well.',
      'Crack eggs into well and add oil and salt.',
      'Gradually incorporate flour into eggs.',
      'Knead for 10 minutes until smooth.',
      'Wrap in plastic and rest for 30 minutes.',
      'Roll dough thin with pasta machine or rolling pin.',
